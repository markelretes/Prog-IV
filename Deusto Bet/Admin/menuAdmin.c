                    ...
                    case 1:
                        do{
                            ...
                            case 1:
                                ...
                                {
                                    printf("Error al actualizar los usuarios en memoria tras modificar los datos");
                                }
                            ...
                            case 2:
                                ...
                                if(resultSQL != SQLITE_OK)
                                {
                                    printf("Error al actualizar los usuarios en memoria tras eliminar el usuario");
                                }
                                break;
